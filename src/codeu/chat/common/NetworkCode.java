...
public final class NetworkCode {
  ...
  public static final int
      ...
      CHANGE_USER_PERMISSION_LEVEL_REQUEST = 46,
      CHANGE_USER_PERMISSION_LEVEL_RESPONSE = 47,
      ADD_USER_NAME_TO_CONVERSATION_REQUEST = 48,
      ADD_USER_NAME_TO_CONVERSATION_RESPONSE = 49,
      ADD_USER_UUID_TO_CONVERSATION_REQUEST = 50,
      ADD_USER_UUID_TO_CONVERSATION_RESPONSE = 51;
}
