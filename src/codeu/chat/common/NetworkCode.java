...
public final class NetworkCode {
  ...
  public static final int
      ...
      ADD_USER_TO_CONVERSATION_REQUEST = 45,
      ADD_USER_TO_CONVERSATION_RESPONSE = 46,
      CHANGE_USER_PERMISSION_LEVEL_REQUEST = 47,
      CHANGE_USER_PERMISSION_LEVEL_RESPONSE = 48,
      ATTEMPT_JOIN_CONVERSATION_REQUEST = 49,
      ATTEMPT_JOIN_CONVERSATION_RESPONSE = 50,
      LIST_USERS_REQUEST = 51,
      LIST_USERS_RESPONSE = 52;
}
